...
// TODO: [mikedorseyjr@] Need to bring this feature set up to partity with the mongodb provider.
// Of course, should make all of these functions require callbacks and update the tests 
// appropriately for parity. [end]
...
/**
 * baseEnvelopeProvider - Returns a brand new EnvelopeProvider with which to start interfacing
 * directly with the backend provider. This is with use of the default connection settings.
 * @return - interface to backend store
 */
